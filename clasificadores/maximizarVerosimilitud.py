...
'''
Clase que implementa un clasificador por medio del metodo de la maximizacion de la verosimilitud
'''
class Maximizar(Clasificador):
    ...
    def __init__(self, clases, norm=False, estocastico=True):
        ...
        self.summary = clasificador.Summary("Maximizar verosimilitud, estocastico: " + str(estocastico))
        None
...
'''
Metodo que implementa el ajuste de pesos estocastico para la maximizacion de la verosimilitud
...
'''
Metodo que implementa el auste de pesos batch para la maximizacion de la verosimilitud
